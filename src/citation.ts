...
// Рядок 3: private static nextId = 0
// Проблема: статичний лічильник не скидається між тестами — тести залежать від порядку виконання
// Категорія: code smell
// Рекомендація: використати crypto.randomUUID() або Date.now() для унікальних ID
